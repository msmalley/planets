...
var bloqpress_loader;
var bloqpress_core = function()
{
    /* 
    ...
    */
    ;(function($, window, document, undefined)
    {
        ...
        // PREVENT DUPLICATES
        $.fn.bloqpress = function(options)
        {
            this.each(function()
            {
                if(!$.data(this, "plugin_bloqpress"))
                {
                    $.data(this, "plugin_bloqpress", new plugin(this, options));
                }
            });
            return this;
        };
        
        $.fn.bloqpress.plugins = {};
        $.fn.bloqpress.patches = {};
        
        // IN-ESCAPABLE INCLUDES
        $.fn.bloqpress.defaults = function()
        {
            if(typeof $.fn.bloqpress.settings.install === 'undefined')
            {
                $.fn.bloqpress.settings.install = true;
            }
            if($.fn.bloqpress.settings.install === false)
            {
                $.fn.bloqpress.settings.cache = false;
            }
            if($.fn.bloqpress.settings.cascade === true && $.fn.bloqpress.settings.install != false)
            {
                var defaults = {
                    dependencies: [
                        'crypto',
                ...
                var modules = $.fn.bloqpress.settings.modules;
                var dependencies = $.fn.bloqpress.settings.dependencies;
                var d_length = bloqpress_functions.array_length(dependencies);
                var m_length = bloqpress_functions.array_length(modules);
                if(!$.isArray($.fn.bloqpress.settings.dependencies))
                {
                    $.fn.bloqpress.settings.dependencies = [];
                }
                if(!$.isArray($.fn.bloqpress.settings.modules))
                {
                    $.fn.bloqpress.settings.modules = [];
                }
                $.each(defaults.dependencies, function(k, dependency)
                {
                    if($.inArray(dependency, dependencies) < 0 || d_length < 1)
                    {
                        $.fn.bloqpress.settings.dependencies.push(dependency);
                    }   
                });
                $.each(defaults.modules, function(k, module)
                {
                    ...
                    {
                        $.fn.bloqpress.settings.modules.push(module);
                    }
                });
            }
        }
        ...
        $.fn.bloqpress.core = {
            ...
            add_action: function(hook, key, bp_module, bp_function, vars)
            {
                if(typeof bp_hooks[hook] == 'undefined') bp_hooks[hook] = {};
                if(typeof bp_vars[hook] == 'undefined') bp_vars[hook] = {};
                if(bp_module.indexOf(".") > -1)
                {
                    var bp_module_array = bp_module.split('.');
                    bp_hooks[hook][key] = $.fn.bloqpress[bp_module_array[0]][bp_module_array[1]][bp_function];
                }
                else
                {
                    bp_hooks[hook][key] = $.fn.bloqpress[bp_module][bp_function];
                }
                bp_vars[hook][key] = vars;
            },
            add_commas: function(num)
            {
                return num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            },
            add_filter: function(hook, key, bp_module, bp_function, vars)
            {
                if(typeof bp_hooks[hook] == 'undefined') bp_hooks[hook] = {};
                if(typeof bp_vars[hook] == 'undefined') bp_vars[hook] = {};
                if(bp_module.indexOf(".") > -1)
            ...
            {
                api = 'bloqpress';
                if(typeof $.fn.bloqpress.settings.default_api != 'undefined')
                {
                    api = $.fn.bloqpress.settings.default_api;
                }
                if(typeof default_service != 'undefined') api = default_service;
                if(
                    typeof $.fn.bloqpress.api != 'undefined'
                    && typeof $.fn.bloqpress.api.api_service != 'undefined'
                ){
                    api = $.fn.bloqpress.api.api_service;
                }
                if($.fn.bloqpress.core.option('api_service'))
                {
                    api = $.fn.bloqpress.core.option('api_service');
                    if(
                        typeof $.fn.bloqpress.api != 'undefined'
                        && typeof $.fn.bloqpress.api.api_service != 'undefined'
                    ){
                        $.fn.bloqpress.api.api_service = api;
                    }
                }
                return api;
            },
            ...
            {
                var result = false;
                var api = $.fn.bloqpress.core.api();
                if(typeof api_provider != 'undefined' && api_provider)
                {
                    api = api_provider;
                }
                if(
                    typeof $.fn.bloqpress.settings.keys != 'undefined'
                    && typeof $.fn.bloqpress.settings.keys.apis[api] != 'undefined'
                    && typeof $.fn.bloqpress.settings.keys.apis[api][property] != 'undefined'
                ){
                    result = $.fn.bloqpress.settings.keys.apis[api][property];
                }
                else if(
                    typeof $.fn.bloqpress.settings.keys != 'undefined'
                    && typeof $.fn.bloqpress.settings.apis != 'undefined'
                    && typeof $.fn.bloqpress.settings.apis.defaults[api] != 'undefined'
                    && typeof $.fn.bloqpress.settings.apis.defaults[api][property] != 'undefined'
                ){
                    result = $.fn.bloqpress.settings.apis.defaults[api][property];
                }
                return result;
            },
            ...
            {
                if(
                    typeof bp_hooks[hook] != 'undefined' 
                    && $.isPlainObject(bp_hooks[hook])
                ){
                    $.each(bp_hooks[hook], function(key, func)
                    {
                        func(bp_vars[hook][key], callback, options);
                    });
                }
            ...
            {
                var snippet_limit = bloqpress_functions.array_length(bootstrap);
                if(key && html)
                {
                    $.fn.bloqpress.snippets[key] = html;
                }
                ...
                {
                    $.fn.bloqpress.core.bootstrap(index + 1, bootstrap, callback);
                }
            },
            bootstrap: function(index, bootstrap, callback)
            {
                var html = false;
                var bs = $.fn.bloqpress;
                var $bs = bloqpress_functions;
                var key = bootstrap[index];
                var url = bs.settings.core_base + 'html/bootstrap/' + key;

                $('.bs.installing').attr('data-loading-content','Now Installing ' + (index + 1) + ' of  '+bloqpress_functions.array_length(bootstrap)+' Bootstrap Snippets');

                var store = false;
                var refresh = bloqpress_functions.vars('refresh');
                var snippet = localStorage.getItem('nw_boot_'+key);
                var cache = $.fn.bloqpress.settings.cache;
            ...
            confirm: function(title, content, confirmed_callback, cancel_callback)
            {
                ...
                $.fn.bloqpress.core.modal(title, content, 'confirm-modal');
                ...
                $($.fn.bloqpress.element).on('hide.bs.modal', '#confirm-modal', function()
                {
                    if(cancel_callback) cancel_callback(false);
                });
            },
            css: function(callback, files)
            {
                ...
                var bs = $.fn.bloqpress;
                var $bs = bloqpress_functions;
                var theme = $.fn.bloqpress.settings.theme;
                var core_css = $.fn.bloqpress.settings.core_base + 'css/';
                var theme_css = $.fn.bloqpress.settings.theme_base + theme + '/css/';
                var child_theme_css = bs.settings.child_theme_base + bs.settings.child_theme + '/css/';
                
                var css_files = $.fn.bloqpress.settings.css;
                var install = $.fn.bloqpress.settings.install;
                ...
                if(css_files && $.isArray(css_files) && install === true)
                {
                    ...
                    $.each(css_files, function(k, v)
                    {
                        ...
                        if(bloqpress_functions.json(css)) css = $.parseJSON(css);
                        var refresh = bloqpress_functions.vars('refresh');
                        ...
                        {
                            // FETCH CSS?
                            bloqpress_functions.exists(theme_css+v+'.css', function(success)
                            {
                                if(success === true)
                                {
                                    bloqpress_functions.get_css(theme_css+v+'.css', store, v);
                                    if((k+1) >= file_len)
                                    {
                                        if(!called)
                                        {
                                ...
                                {
                                    bloqpress_functions.exists(core_css+v+'.css', function(success)
                                    {
                                        if(success === true)
                                        {
                                            bloqpress_functions.get_css(core_css+v+'.css', store, v);
                                            if((k+1) >= file_len)
                                            {
                                                if(!called)
                                                {
                                        ...
                                        {
                                            bloqpress_functions.exists(child_theme_css+v+'.css', function(success)
                                            {
                                                if(success === true)
                                                {
                                                    bloqpress_functions.get_css(child_theme_css+v+'.css', store, v);
                                                    if((k+1) >= file_len)
                                                    {
                                                        if(!called)
                                                        {
                    ...
                    if(typeof $.fn.bloqpress.settings.skin != 'undefined' && $.fn.bloqpress.settings.skin)
                    {
                        skin = $.fn.bloqpress.settings.skin;
                        var skin_url = $.fn.bloqpress.settings.theme_base + theme + '/skins/' + skin + '/css/styles.css';
                        bloqpress_functions.get_css(skin_url, true, skin);
                    }
                }
            ...
            defaults: function()
            {
                if(!$.isPlainObject($.fn.bloqpress.data))
                {
                    var data_functions = {
                    ...
                    $.fn.bloqpress.data = data_functions;
                }
                if(!$.isPlainObject($.fn.bloqpress.security))
                {
                    ...
                    $.fn.bloqpress.security = security_functions;
                }
            },
            filter: function(data)
            {
                ...
                if(filters)
                {
                    ...
                    { 
                        ...
                        {
                            data[k] = filters[v.func]($.fn.bloqpress, v);
                        }
                        else if($.isPlainObject(v) || $.isArray(v))
                        {
                            data[k] = $.fn.bloqpress.core.filter(v);
                        }
                    });
                    return data;
                }
            ...
            forms: function()
            {
                ...
                if(localStorage)
                {
                    ...
                    {
                        var obj = value;
                        if(bloqpress_functions.json(value))
                        {
                            obj = $.parseJSON(value);
                        }
                        ...
                        else if(key.substring(0, 14) == 'nw_bloqpress_')
                        {
                            var key_array = key.split('_bloqpress_');
                            if(!$.isPlainObject(objs['nw_bloqpress']))
                            {
                                objs['nw_bloqpress'] = {};
                            }
                            objs['nw_bloqpress'][key_array[1]] = obj;
                        }
                ...
                $($.fn.bloqpress.element).find('textarea.data-backup').val(backup);
                $($.fn.bloqpress.element).find('input.filestyle').each(function(i)
                {
                    var input = $(this);
                    $(this).filestyle({
                    ...
                    {
                        $.fn.bloqpress.core.image(this, function(img)
                        {
                            $(input).attr('data-img', img);
                        });
                    });
                });
                $($.fn.bloqpress.element).find("input.switch").each(function()
                {
                ...
                $($.fn.bloqpress.element).on('change', '.bs-dobs', function(i)
                {
                ...
                $($.fn.bloqpress.element).on('change', 'input#import_file', function(i)
                {
                    $.fn.bloqpress.core.txt(this, function(txt)
                    {
                        $($.fn.bloqpress.element).find('textarea#import-data').val(txt);
                        $($.fn.bloqpress.element).find('button#submit-import').trigger('click');
                    });
                });
                $($.fn.bloqpress.element).on('change', '#access-account', function(i)
                {
                    var value = $(this).val();
                    ...
                    if(value === 'print')
                    {
                        ...
                        $.fn.bloqpress.core.print(title, contents);
                    }
                    else if(value === 'access')
                    {
                        $.fn.bloqpress.accounts.access(account_id, false, chain);
                    }
                    else if(value === 'import')
                    {
                        var account = $.fn.bloqpress.accounts.get(account_id, false)[chain];
                        var fee = $.fn.bloqpress.settings.blockchains[chain].fee;
                        var options = {
                        ...
                        var form = $.fn.bloqpress.forms.process(options);
                        ...
                        $.fn.bloqpress.core.modal('Import Private Key', intro + form);
                    }
                });
                $($.fn.bloqpress.element).on('change', '#api_service', function(i)
                {
                    var value = $(this).val();
                    $.fn.bloqpress.api.api_service = value;
                });
                $($.fn.bloqpress.element).find('.bs-blockchain-select').each(function(i)
                {
                    var select = $(this);
                    var hd = false;
                    var prepend = false;
                    var blockchains = $.fn.bloqpress.settings.blockchains;
                    ...
                    if($.isPlainObject(blockchains))
                    {
                        ...
                        $.each(blockchains, function(blockchain, v)
                        {
                            ...
                            {
                                if(typeof v.apis[$.fn.bloqpress.core.api()] != 'undefined')
                                {
                ...
                $($.fn.bloqpress.element).find('.bs-insert-salt').each(function(i)
                {
                    var input = this;
                    $.fn.bloqpress.data.find('bloqpress', 'salt', function(salt)
                    {
                        $(input).val(salt);
                    });
                });
                $($.fn.bloqpress.element).find('.bs-api-select').each(function(i)
                {
                    var select = $(this);
                    var apis = $.fn.bloqpress.settings.apis.available;
                    var current_api = $.fn.bloqpress.core.api();
                    $(select).html('');
                ...
                $($.fn.bloqpress.element).find('.bs-account-select').each(function(i)
                {
                    var select = $(this);
                    var accounts = $.fn.bloqpress.accounts.get();
                    $(select).html('');
                    if($.isArray(accounts))
                    {
                ...
                $($.fn.bloqpress.element).on('submit', '#bloqpress-login', function(e)
                {
                    e.preventDefault();
                    $(this).find('button[type="submit"]').trigger('click');
                });
                $($.fn.bloqpress.element).on('submit', '#verify-ownership', function(e)
                {
                    e.preventDefault();
                    $(this).find('button[type="submit"]').trigger('click');
                });                
                $($.fn.bloqpress.element).find('form').each(function(i)
                {
                    var form = $(this);
                    ...
                    $(form).find('input[type="pass"]').on('focus', function()
                    {
                        ...
                        }, $.fn.bloqpress.core.timeouts('remove_temp_password'));
                    });
                    if($(this).find('[type="submit"]').length < 1)
                    {
                        $(form).find('input').keypress(function(e) 
                        {
                            ...
                            {
                                if(
                                    $(form).attr('id') == 'bloqpress-setup-step1-left'
                                    || $(form).attr('id') == 'bloqpress-setup-step1-right'
                                    || $(form).attr('id') == 'bloqpress-setup-step2-left'
                                    || $(form).attr('id') == 'bloqpress-setup-step2-right'
                                ){
                                    $($.fn.bloqpress.element).find('#next-step').trigger('click');
                                }
                                else
                                {
                                    $(form).submit();
                ...
                $($.fn.bloqpress.element).on('submit', '#search-form', function(e)
                {
                    e.preventDefault();
                    var results = {
                        accounts: [],
                    ...
                    if(
                        bloqpress_functions.array_length(results.accounts) > 0
                        || bloqpress_functions.array_length(results.contacts) > 0
                    ){
                        title = 'Results';
                        contents = '';
                        if(bloqpress_functions.array_length(results.accounts))
                        {
                        ...
                        if(bloqpress_functions.array_length(results.contacts))
                        {
                ...
                if($('#bloqpress-login').length > 0)
                {
                    setTimeout(function()
                    {
                        $('#bloqpress-login #login-username').val('');
                        $('#bloqpress-login #login-password').val('');
                    }, $.fn.bloqpress.core.timeouts('clear_forms'));
                }
            },
            get: function(file, extension, callback, skip, cached)
            {
                ...
                var store = true;
                var cache = bs.settings.cache;
                if(typeof cache == 'undefined' || typeof cache[extension] == 'undefined' || cache[extension] === false)
                {
                    store = false;
                }
            ...
            init: function()
            {
                ...
                setTimeout(function()
                {
                    ...
                    {
                        $.fn.bloqpress.core.publicize(function()
                        {
                            ...
                            var init_callback = function(nav)
                            {
                                ...
                                $($.fn.bloqpress.element).on('submit', 'form.bs', function(e)
                                {
                                    e.preventDefault();
                                    var form = this;
                                    var func = $(form).attr('data-function');
                                    var vars = $(form).data();
                                    if(typeof func != 'undefined' && typeof $.fn.bloqpress.forms[func] == 'function')
                                    {
                                        $.fn.bloqpress.forms[func](form, vars);
                                    }
                                });
                            ...
                            else if(!init_bs)
                            {
                                ...
                                {
                                    var url = '../../../bloqpress/html/bootstrap/login';
                ...
                }, $.fn.bloqpress.core.timeouts('delayed_init'));
            },
            less: function(callback)
            {
                var use_less = true;
                if($.fn.bloqpress.settings.less === false) use_less = false;
                if(use_less)
                {
                    var less = localStorage.getItem('nw_inc_less');
                    if(bloqpress_functions.json(less)) less = $.parseJSON(less);
                    var refresh = bloqpress_functions.vars('refresh');
                    var cache = $.fn.bloqpress.settings.cache;
                    var store = true;
                    ...
                    {
                        $('head').append('<link rel="stylesheet/less" type="text/css" href="' + $.fn.bloqpress.settings.theme_base + $.fn.bloqpress.settings.theme + '/less/bloqpress.less">');
                        bloqpress_functions.js('js-bloqpress-less', $.fn.bloqpress.settings.core_base+'js/less.js', function()
                        {
                            ...
                            $('style').each(function()
                            {
                                // less-bloqpress
                                var id = $(this).attr('id');
                                var string_to_count = 'less-bloqpress';
                                ...
                                if(id)
                                {
                                    ...
                                    if(check === 'less:' && double_check === 'less-bloqpress')
                                    {
            ...
            {
                $.fn.bloqpress.core.upgrade(saved_version, this_version, refresh, function()
                {
                    if($($.fn.bloqpress.element).length < 1)
                    {
                        return false;
                    }
                    else
                    {
                        $.fn.bloqpress.core.defaults();
                        $.fn.bloqpress.core.init();
                    }
                });
            },
            loader: function(state, text)
            {
                ...
                $.fn.bloqpress.core.modals('close_all');
                var element = $($.fn.bloqpress.element);
                if(typeof $.fn.bloqpress.settings.loader_id != 'undefined')
                {
                    element = $('#'+$.fn.bloqpress.settings.loader_id);
                }
                if(state && state === 'open')
                {
                    $(element).addClass('loading');
                    $($.fn.bloqpress.element).attr('data-loading-content', text);
                }
                else
                {
            ...
            loading: function(text, add_loading_class)
            {
                ...
                {
                    $($.fn.bloqpress.element).addClass('loading');
                }
            },
            ...
            modals: function(action)
            {
                if(action)
                {
                    if(action === 'close_all')
                    {
                        var space = $.fn.bloqpress.element;
                ...
                {
                    $($.fn.bloqpress.element).on('show.bs.modal', '.modal', function(i)
                    {
                        var this_id = $(this).attr('id');
                        var this_form = $(this).find('form');
                        $($.fn.bloqpress.element).find('.modal').each(function(i)
                        {
                    ...
                    $($.fn.bloqpress.element).on('shown.bs.modal', '.modal', function(i)
                    {
                    ...
                    $($.fn.bloqpress.element).on('show.bs.modal', '#new-account-modal', function(i)
                    {
            ...
            nav: function(slug)
            {
                if(slug == $.fn.bloqpress.settings.page_base) slug = $.fn.bloqpress.settings.slug_base;
                var nav = $($.fn.bloqpress.element).find('#' + $.fn.bloqpress.settings.navigation_id);
                var mnav = $($.fn.bloqpress.element).find('#' + $.fn.bloqpress.settings.mobile_nav_id);
                $(nav).find('.active').removeClass('active');
                $(mnav).find('.active').removeClass('active');
                var original_slug = JSON.parse(JSON.stringify(slug));
                if(slug.charAt(0) != '#') slug = '#' + $.fn.bloqpress.core.apply_filters('nav_slug', slug, slug);
                $(nav).find(slug).addClass('active');
                $(mnav).find(slug).addClass('active');
                $.fn.bloqpress.core.apply_actions('core_nav_complete', function()
                {
            ...
            option: function(key, default_value)
            {
                ...
                var bs = $.fn.bloqpress;
                var $bs = bloqpress_functions;
                var options = localStorage.getItem('nw_bloqpress_options');
            ...
            page: function()
            {
                if(window.location.hash)
                {
                    ...
                    $.fn.bloqpress.settings.page = slug_array[1];
                }
                else
                {
                    $.fn.bloqpress.settings.page = $.fn.bloqpress.settings.page_base;
                }
                return $.fn.bloqpress.settings.page;
            },
            patch: function(version, callback)
            {
                var file = $.fn.bloqpress.settings.core_base+'patches/'+version+'/patch-'+version+'.js';
                $.getScript(file, function(patch_js)
                {
                    $.fn.bloqpress.patches['patch'+version].init(callback)
                });
            },
            plugins: function(index, plugins, callback)
            {
                ...
                $('.bs.installing').attr('data-loading-content','Now Installing ' + (index + 1) + ' of  '+bloqpress_functions.array_length(plugins)+' Plugins');
                ...
                else if($.isArray(plugins))
                {
                    ...
                    if(bloqpress_functions.json(plug)) plug = $.parseJSON(plug);
                    var refresh = bloqpress_functions.vars('refresh');
                    var cache = bs.settings.cache;
                    var store = true;
            ...
            publicize: function(callback)
            {
                ...
                if(public === true)
                {
                    ...
                    {
                        bs.data.find('bloqpress', 'salt', function(salt)
                        {
                            if(salt)
                            {
                                ...
                                else
                                {
                                    if(security)
                                    {
                                        $.fn.bloqpress.settings.role = 'admin';
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                if(security)
                                {
                                    $.fn.bloqpress.settings.role = 'user';
                                }
                                if(callback) callback();
                            }
                        });
            ...
            ready: function()
            {
                ...
                */
                $.fn.bloqpress.core.table();
                $.fn.bloqpress.core.forms();
                
                var page = $.fn.bloqpress.core.page();
                $.fn.bloqpress.core.nav(page);
                $.fn.bloqpress.core.filters(page);

                // TODO: 
                // Handle inactive modules?
                if($.isPlainObject($.fn.bloqpress.theme))
                {
                    if($.isFunction($.fn.bloqpress.theme.new))
                    {
                        $.fn.bloqpress.theme.new();
                    }
                }
                if($.isPlainObject($.fn.bloqpress.buttons))
                {
                    if($.isFunction($.fn.bloqpress.buttons.new))
                    {
                        $.fn.bloqpress.buttons.new();
                    }
                }
                $.fn.bloqpress.core.apply_actions('ready'); 
            },
            ...
            resize: function(delay)
            {
                ...
                {
                    resize_timeout = true;
                    setTimeout($.fn.bloqpress.core.resized, delay);
                }
            },
            ...
            {
                if(!salt) salt = $.fn.bloqpress.settings.id;
                var keys = [];
                if($.isPlainObject(modules))
                {
                    ...
                    else
                    {
                        $.each(modules, function(k, v)
                        {
                            ...
                            if($.isArray($.fn.bloqpress.settings.store))
                            {
                                $.each($.fn.bloqpress.settings.store, function(store_index, store_key)
                                {
                                    if(store_key === k)
                                    {
                                        if(k == 'your_password') 
                                        ...
                                        $.fn.bloqpress.data.save('keys', store_key, safe_v, function()
                                        {
                            ...
                            salt = CryptoJS.SHA3(
                                salt + k.toLowerCase() + bloqpress_functions.slug(v).toLowerCase(), 
                                { outputLength: 512 }
                            );
            ...
            {
                $.fn.bloqpress.settings.vars = bloqpress_functions.vars();
                if(bloqpress_functions.vars('less'))
                {
                    $.fn.bloqpress.settings.less = true;
                }
                if(!$.fn.bloqpress.settings.base_url)
                {
                    var base_url = window.location.href.split('#')[0];
                    $.fn.bloqpress.settings.base_url = base_url.split('?')[0];
                }
                $.fn.bloqpress.settings.info = {};
                ...
                $.fn.bloqpress.element = element;

                if($($.fn.bloqpress.element).length > 0)
                {
                    $($.fn.bloqpress.element).addClass('bloqpress-wrapper loading');

                    // DATA ATTRIBUTES
                    var attributes = $($.fn.bloqpress.element).data();
                    ...
                    $.each(attributes, function(key, value)
                    {
                        if(typeof value == 'string')
                        {
                            ...
                            if(first_char == '[' && last_char == ']')
                            {
                                ...
                                {
                                    key_array = key.split('.');
                                    if(bloqpress_functions.array_length(key_array) == 2)
                                    {
                                        $.fn.bloqpress.settings[key_array[0]][key_array[1]] = keys.split(', ');
                                    }
                                }
                                else
                                {
                                    $.fn.bloqpress.settings[key] = keys.split(', ');
                                }
                            }
                            else
                            {
                                if(key.indexOf(".") > -1)
                                {
                                    ...
                                    if(bloqpress_functions.array_length(key_array) == 2)
                                    {
                                        $.fn.bloqpress.settings[key_array[0]][key_array[1]] = value;
                                    }
                                }
                                else
                                {
                                    $.fn.bloqpress.settings[key] = value;
                                }
                            }
                        }
                        else
            ...
            table: function()
            {
                $($.fn.bloqpress.element).find('table.data-table').each(function(i)
                {
                    ...
                    else
                    {
                        ...
                        $.fn.bloqpress.core.table[$(this).attr('id')] = $(this).DataTable({
                            searching: search,
                            dom: dom,
            ...
            test_results: function(expected, given, index, total, title, api_service, chain_count, chain_total)
            {
                ...
                if($.isPlainObject(expected) || $.isArray(expected))
                {
                    ...
                    $.each(expected, function(key, result)
                    {
                        ...
                        var expected_total = bloqpress_functions.array_length(result);
                        ...
                        if(passed === true && typeof provided_results[api_service] == 'undefined')
                        {
                            ...
                            full_results[api_service].results+= '<strong class="black">API Request using '+$.fn.bloqpress.settings.apis.available[api_service]+':</strong><br />'+title;
                    ...
                    if(index >= total && chain_count >= chain_total)
                    {
                                ...
                                if(blockchain != 'multi')
                                {
                                    $.each(values.apis, function(provider, url)
                                    {
                                        if(typeof full_results[provider] != 'undefined')
                                        {
                                            ...
                                            var relay = $.fn.bloqpress.api.settings(
                                                blockchain, 
                                                provider, 
                                                'to', 
                                                'relay'
                                            ...
                                            var op_returns = $.fn.bloqpress.api.settings(
                                                blockchain, 
                                                provider, 
                                                'to', 
                                                'op_returns'
                                            ...
                                            var dnkeys = $.fn.bloqpress.api.settings(
                                                blockchain, 
                                                provider, 
                                                'to', 
                                                'dnkeys'
                        ...
                        provided_results = {};
                        test_result_content = $.fn.bloqpress.core.test_results_table(full_results) + '<a href="#" class="btn-hidden_toggler btn btn-success btn-block" data-id="full-results">FULL RESULTS</a><div style="display: none" id="full-results">';
                        $.each(bs.settings.blockchains, function(blockchain, values)
                        {
                            if(blockchain != 'multi')
                            {
                        ...
                        $.fn.bloqpress.core.modal('Test Results', test_result_content);
                        $('#bloqpress').removeClass('loading');
                    }
                }
            },
            test_results_table: function(results)
            {
                ...
                html+= '<table class="table table-striped test-results">';
                    ...
                    html+= '<tbody>';
                        ...
                        {
                            html+= '<tr>';
                                html+= '<td><strong>'+$.fn.bloqpress.settings.apis.available[provider]+'</strong></td>';
            ...
            tests: function(run)
            {
                ...
                if(
                    ...
                    chain_total = bloqpress_functions.array_length(bs.settings.blockchains.btc.apis);
                    for (i = 0; i < bloqpress_functions.array_length(bs.settings.blockchains.btc.apis); i++) 
                    {
            ...
            timeouts: function(type_or_value)
            {
                ...
                if(typeof $.fn.bloqpress.settings.timeouts != 'undefined')
                {
                    if(typeof $.fn.bloqpress.settings.timeouts[required_type] != 'undefined')
                    {
                        required_value = $.fn.bloqpress.settings.timeouts[required_type];
                    }
                    else if(typeof $.fn.bloqpress.settings.timeouts.default != 'undefined')
                    {
                        required_value = $.fn.bloqpress.settings.timeouts.default;
                    }
                }
                if(required_value <= 0)
                {
            ...
            {
                var settings = $.fn.bloqpress.settings;
                var $bs = bloqpress_functions;
                ...
                if(/^[0-9\.]+$/.test(saved_version) && /^[0-9\.]+$/.test(this_version)) 
                {
                    ...
                    if(
                        ...
                        && bloqpress_functions.array_length(current_version_array) > 3
                        && bloqpress_functions.array_length(stored_version_array) > 3
                        && stored_version_array[0] < 1
                        && stored_version_array[1] < 6
                    )
                    {
                        $.fn.bloqpress.core.patch('0600', function()
                        {
                    ...
                    {
                        $.fn.bloqpress.core.patch('0501', function()
                        {
                            $.fn.bloqpress.core.patch('0502', callback);
                        });
                    }
                    else if(
                        $.isArray(stored_version_array)
        ...
        function plugin(element, options, defaults, store, force_skip)
        {
            if(!is_loaded)
            {
                ...
                var old_settngs = {};
                if(typeof $.fn.bloqpress.settings != 'undefined')
                {
                    old_settings = $.fn.bloqpress.settings;
                }
                ...
                $.fn.bloqpress.core.get('themes/config', 'json', function(results)
                {
                    if($.isPlainObject(results))
                    {   
                        $.fn.bloqpress.settings = $.extend({}, settings, results);

                        // MERGE WITH HTML ATTRBUTE OPTIONS
                        $.fn.bloqpress.core.settings(element);

                        if($.fn.bloqpress.settings.skip_config) skip = true;

                        // NOW NEED TO GET THEME SPECIFIC OPTIONS AND MERGE WITH THESE
                        var current_theme = $.fn.bloqpress.settings.theme;
                        $.fn.bloqpress.core.get('themes/'+current_theme+'/config', 'json', function(results)
                        {
                            if($.isPlainObject(results))
                            {   
                                ...
                                var set = $.extend(
                                    {}, 
                                    $.fn.bloqpress.settings, 
                                    results
                                );

                                $.fn.bloqpress.settings = set;

                                $.fn.bloqpress.defaults();
                                ...
                                $.fn.bloqpress.core.get(secret_config, 'json', function(results)
                                {
                                    if($.isPlainObject(results))
                                    {
                                        $.fn.bloqpress.settings = $.extend(
                                            {}, 
                                            $.fn.bloqpress.settings, 
                                            results
                                        );
                                    ...
                                    else
                                    {
                                        if(store)
                                        {
                                            localStorage.setItem('nw_inc_config', JSON.stringify($.fn.bloqpress.settings));
                                        }
                                        ...
                                        var dependencies = $.fn.bloqpress.settings.dependencies;
                                        var modules = $.fn.bloqpress.settings.modules;
                                        var bootstrap = $.fn.bloqpress.settings.bootstrap;
                                        var plugins = $.fn.bloqpress.settings.plugins;
                                        
                                        var child_modules = false;
                                        if(
                                            typeof $.fn.bloqpress.settings.child_modules != 'undefined'
                                            && typeof $.fn.bloqpress.settings.child_theme != 'undefined'
                                            && $.isArray($.fn.bloqpress.settings.child_modules)
                                        ){
                                            child_modules = $.fn.bloqpress.settings.child_modules;
                                            if($.isArray(modules) && $.isArray(child_modules))
                                            {
                                                $.each(child_modules, function(cm)
                                                {
                                                    modules.push(child_modules[cm]);
                                                }); 
                                            }
                                            else if($.isArray(child_modules))
                                            {
                                        ...
                                        if(plugins)
                                        {
                                            $.each(plugins, function(k, plugin)
                                            {
                                                ...
                                                if(
                                                    typeof $.fn.bloqpress.settings.plugin != 'undefined'
                                                    && typeof $.fn.bloqpress.settings.plugin.dependencies != 'undefined'
                                                    && typeof $.fn.bloqpress.settings.plugin.dependencies[plugin_key] != 'undefined'
                                                    && $.isArray($.fn.bloqpress.settings.plugin.dependencies[plugin_key])
                                                ){
                                                    var plugin_dependencies = $.fn.bloqpress.settings.plugin.dependencies[plugin_key];
                                        ...
                                        if($.fn.bloqpress.settings.vars)
                                        {
                                            var vars = $.fn.bloqpress.settings.vars;
                                            if(typeof vars.skin != 'undefined' && vars.skin)
                                            {
                                                $.fn.bloqpress.settings.skin = vars.skin;
                                            }
                                        }
                                        ...
                                        $bs.update(bs.settings.v, function(saved_version, this_version, refresh)
                                        {
                                            ...
                                            {
                                                // INSERT CSS
                                                var active_css = bs.settings.css;
                                                var child_css = false;
                                                if(
                                                    typeof bs.settings.child_css != 'undefined'
                                                    && $.isArray(bs.settings.child_css)
                                                ){
                                                    if($.isArray(active_css))
                                                    {
                                                        $.each(bs.settings.child_css, function(cc)
                                                        {
                                                            active_css.push(bs.settings.child_css[cc]);
                                                        });
                                                    }
                                                    else
                                                    {
                                                        active_css = bs.settings.child_css;
                                                    }
                                                }
                                                bs.core.css(function()
                                                {
                                                    $('html').animate({"opacity": 1}, 350, function()
                                                    {
                                                        // CLEANER CALLBACK TIME ???
                                                    });
                                                                ...
                                                                $bs.include(bs, 0, modules, function()
                                                                {
                                                                    if($.fn.bloqpress.settings.vars)
                                                                    {
                                                                        ...
                                                                        if(typeof vars.skin != 'undefined' && vars.skin)
                                                                        {
                                                                            $.fn.bloqpress.settings.skin = vars.skin;
                                                                            var theme = $.fn.bloqpress.settings.theme;
                                                                            var theme_base = $.fn.bloqpress.settings.theme_base;
        ...
        if(typeof bloqpress_defaults == 'undefined')
        {
            var bs = $.fn.bloqpress;
            var $bs = bloqpress_functions;
            var config = localStorage.getItem('nw_inc_config');
            if(bloqpress_functions.json(config)) config = $.parseJSON(config);
            ...
            if(typeof $.fn.bloqpress.settngs == 'undefined')
            {
                $.fn.bloqpress.settings = {};
            }
            if(typeof $.fn.bloqpress.settings.install == 'undefined')
            ...
            var theme = localStorage.getItem('nw_bloqpress_theme');
            if(bloqpress_functions.json(theme)) theme = $.parseJSON(theme);

            if(config && $.fn.bloqpress.settings.theme != config.theme)
            {
            ...
            if(!config || refresh === true || store === false)
            {
                $.ajax({
                    ...
                    success: function(defaults)
                    {
                        ...
                        bloqpress_functions.check(defaults, function(passed)
                        {
                            if(passed) plugin(false, false, defaults, store); 
                            else alert('Your browser does not support the minimum requirements - please learn more at https://github.com/bloqpress/framework/tree/master/docs/en - either that or you may have private browsing activated, which would also prevent bloqpress from working.');
                        });
                    }
                }).fail(function(jqxhr, settings, exception)
                {
                    alert('It seems this browser is unable to load files via AJAX under the current environment. This is usually only a problem when opening bloqpress without a web-server. It\'s typically a Chrome issue. Try using Firefox, Safari, or even Internet Explorer.');
                });
            }
            else
            {
                var skip = true;
                bloqpress_functions.check(config, function(passed)
                {
        ...
        {
            if(bloqpress_functions.json(bloqpress_defaults))
            {
                bloqpress_defaults = $.parseJSON(bloqpress_defaults);
            }
            $.fn.bloqpress.settings = bloqpress_defaults;
            bloqpress_functions.check(bloqpress_defaults, function()
            {
                var element = false;
                $.fn.bloqpress.settings.vars = bloqpress_functions.vars();
                if($('#'+$.fn.bloqpress.settings.id).length > 0)
                {
                    element = $('#'+$.fn.bloqpress.settings.id);
                }
                plugin(element, false, bloqpress_defaults); 
            });
        }
    })
...
*/
var bloqpress_js_files = {};
var bloqpress_outputted = false;
var bloqpress_functions = {
    ...
    get_css: function(attributes, store, id)
    {
        ...
        var head = document.getElementsByTagName("head")[0];
        head.appendChild(styleSheet); 
        var cahce = $.fn.bloqpress.settings.cache;
        if(typeof cache == 'undefined' || typeof cache[extension] == 'undefined' || cache[extension] === false)
        {
            store = false;
        }
    ...
    include: function(bloqpress, start, files, callback, dependency)
    {
        var head = document.getElementsByTagName('head')[0];
        var refresh = bloqpress_functions.vars('refresh');
        var cache = bloqpress.settings.cache;
        var limit = files.length;
        //var install = bloqpress.settings.install;
        var install = true;
        ...
        $('.bs.installing').attr('data-loading-content','Now Installing ' + (start + 1) + ' of  '+bloqpress_functions.array_length(files)+' ' + include_type);
        if(install === false)
        {
            callback();
        }
        else if($.isArray(files) && files[start])
        {
            ...
            //var store = true;
            var store = false;
            if(bloqpress_functions.json(js_file)) js_file = $.parseJSON(js_file);
            if(!dependency)
            {
            ...
            if(bloqpress.settings.cascade === false)
            {
            ...
            {
                // INCLUDE CORE
                var filename = bloqpress.settings.core_base + bloqpress.settings.dependency_base + file_name + '.js';
                var child_filename = false;
                var bs = $.fn.bloqpress;
                if(
                    typeof bs.settings.child_theme_base != 'undefined'
                    && typeof bs.settings.child_theme != 'undefined'
                ){
                    child_filename = bs.settings.child_theme_base + bs.settings.child_theme + '/' + bloqpress.settings.dependency_base + file_name + '.js';
                }
                
                if(!dependency)
                {
                    filename = bloqpress.settings.core_base + bloqpress.settings.module_base + file_name + '.js';
                    
                    if(
                        typeof bs.settings.child_theme_base != 'undefined'
                        && typeof bs.settings.child_theme != 'undefined'
                    ){
                        child_filename = bs.settings.child_theme_base + bs.settings.child_theme + '/' + bloqpress.settings.module_base + file_name + '.js';
                    }
                    
                }
                $.getScript(child_filename, function(child_js)
                {
                    if(child_js != '404')
                    {
                        js+= "\n" + child_js;
                    ...
                    $.getScript(filename, function(core_js)
                    {
                        ...
                        var theme_filename = bloqpress.settings.theme_base + bloqpress.settings.theme+'/js/dependencies/' + file_name + '.js';
                        if(!dependency)
                        {
                            theme_filename = bloqpress.settings.theme_base + bloqpress.settings.theme+'/js/modules/' + file_name + '.js';
                        }
                        $.getScript(theme_filename, function(theme_js)
                        {
                            ...
                            start++;
                            bloqpress_functions.include(bloqpress, start, files, callback, dependency);
                        }).fail(function(jqxhr, settings, exception)
                        {
                            start++;
                            if(store === true && file_name != 'bitcoinjs-lib')
    ...
    initialize: function()
    {
        if(!bloqpress_outputted) 
        {
            bloqpress_outputted = true;
            if(typeof(jQuery) === 'undefined') 
            {
                bloqpress_functions.js(
                    'js-bloqpress-jquery', 
                    'bloqpress/js/dependencies/jquery.min.js', 
                    function()
                    {
                        bloqpress_core();
                    }
    ...
    {
        var results = localStorage.getItem('nw_bloqpress_v');
        if(results && bloqpress_functions.json(results)) results = $.parseJSON(results);
        if(/^[0-9\.]+$/.test(version) && /^[0-9\.]+$/.test(results)) 
        {
            ...
            if($.isArray(stored_version_array))
            {
                $.each(stored_version_array, function(k, v)
                {
                    ...
                    {
                        $.fn.bloqpress.settings.vars.refresh = true;
                    }
                    if(k >= (bloqpress_functions.array_length(stored_version_array) - 1))
                    {
                        localStorage.setItem('nw_bloqpress_v', JSON.stringify(version));
                        callback(results, version, $.fn.bloqpress.settings.vars.refresh);
                    }
                })
            }
            else
    ...
    vars: function(variable)
    {
        ...
        {
            if(
                typeof $.fn.bloqpress.settings == 'undefined' 
                || typeof $.fn.bloqpress.settings == null 
                || !$.fn.bloqpress.settings
                || typeof $.fn.bloqpress.settings.vars == 'undefined'
                || typeof $.fn.bloqpress.settings.vars[variable] == 'undefined'
            ){
                return false;
            }
            else
            {
                return $.fn.bloqpress.settings.vars[variable];
            }
        }
        else
        {
            ...
            $.fn.bloqpress.settings.vars = vars;
            return vars;
        }
    }
};
var bloqpress_js_scripts;
document.addEventListener('DOMContentLoaded', function()
{
    //bloqpress_functions.initialize();
});
bloqpress_functions.initialize();