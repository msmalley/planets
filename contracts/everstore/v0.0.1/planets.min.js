...
contract InterplanetaryEmbassy is ERC721
{
    ...
    public 
    {
        updateProxy(proxyForAddress, proxyForString, proxyForUint, proxyForUints);
    }
    ...
    {
        address aNull; uint uNull; bytes32 bNull;
        require(_String.read('universe', '') != bNull);
        _String.set('universe', stringToBytes32(UniverseName), '');
    ...
    */
    ...
    {
        return Uints.read(beneficiary, 'balance', 0);
    }
    ...
    function updateTokenMetadata(uint id, string meta) internal returns(bool)
    {
        ...
        _String.Sets(id, 'meta', stringToBytes32(meta), '');
    ...
    */
    ...
    {
        string memory universe = bytes32ToString(_String.read('universe', ''));
    ...
    function generate_token(address beneficiary, uint256 id, string name) internal
    {
        ...
        Uint.set('total', Uint.read('total', 0) + 1, 0);
        _String.Sets(id, 'meta', stringToBytes32(name), '');
    ...
    internal
    {
        ...
        Uint.Sets(id, 'planet_x', xCoordinate, 0);
        Uint.Sets(id, 'planet_y', yCoordinate, 0);
        Uint.Sets(id, 'planet_z', zCoordinate, 0);
        Uint.Sets(id, 'planet_cost', value, 0);
        _String.Sets(id, 'planet_name', stringToBytes32(name), '');
        _String.Sets(id, 'planet_liason', stringToBytes32(liason), '');
        _String.Sets(id, 'planet_url', stringToBytes32(url), '');
    }
    ...
    public payable 
    {
        ...
        uint256 id = uid(xCoordinate, yCoordinate, zCoordinate);
        address donation_address = Address.read('donation_address', aNull);
        uint minimum_donation = Uints.read(donation_address, 'donation_amount', 0);
        uint coordinate_limit = Uint.read('coordinate_limit', 0);
    ...
    function getPlanet(uint xCoordinate, uint yCoordinate, uint zCoordinate) public view returns(
        ...
        return(
            Uint.Reads(id, 'planet_x', 0),
            Uint.Reads(id, 'planet_y', 0),
            Uint.Reads(id, 'planet_z', 0),
            Uint.Reads(id, 'planet_cost', 0),
            Address.Reads(id, 'planet_owner', 0)
        );
    }
    ...
    function UpdateDonationAddress(address NewAddress) onlyOwner public
    {
        ...
        address donation_address = Address.read('donation_address', aNull);
        Uints.set(donation_address, 'donation_start', Uints.read(OldAddress, 'donation_start', 0), 0);
        Uints.set(donation_address, 'donation_genesis', Uints.read(OldAddress, 'donation_genesis', 0), 0);
        Uints.set(donation_address, 'donation_checkpoint', Uints.read(OldAddress, 'donation_checkpoint', 0), 0);
        Uints.set(donation_address, 'donation_interval', Uints.read(OldAddress, 'donation_interval', 0), 0);
        Uints.set(donation_address, 'donation_ppp', Uints.read(OldAddress, 'donation_ppp', 0), 0);
        Uints.set(donation_address, 'donation_amount', Uints.read(OldAddress, 'donation_amount', 0), 0);
    }
    ...
    function updatePlanetLiason(uint xCoordinate, uint yCoordinate, uint zCoordinate, string LiasonName) public 
    {
        ...
        _String.Sets(id, 'planet_liason', stringToBytes32(LiasonName), '');
    }
